    ...
    function create_fragment$7(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(meta2, "content", "width=device-width,initial-scale=1");
    			attr(meta3, "name", "viewport");
    			attr(meta3, "content", "width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no");
    			attr(meta4, "name", "description");
    			attr(meta4, "content", "Svelte Interactive Article Starter");
    			attr(meta5, "property", "og:image");
    			attr(meta5, "content", "");
    			attr(meta6, "property", "og:title");
    			attr(meta6, "content", "Svelte Interactive Article Starter");
    			attr(meta7, "property", "og:description");
    			attr(meta7, "content", "Svelte Interactive Article Starter");
    			attr(meta8, "property", "og:image:width");
    			attr(meta8, "content", "1000");
    			attr(meta9, "property", "og:image:height");
    			attr(meta9, "content", "630");
    		},
    		m(target, anchor) {
    			append$1(document.head, meta0);
    			append$1(document.head, meta1);
    			append$1(document.head, meta2);
    			append$1(document.head, meta3);
    			append$1(document.head, meta4);
    			append$1(document.head, meta5);
    			append$1(document.head, meta6);
    			append$1(document.head, meta7);
    			append$1(document.head, meta8);
    			append$1(document.head, meta9);
    		},
    		p: noop,
    		i: noop,
    		o: noop,
    ...
    function create_fragment$6(ctx) {
    	...
    	return {
    		c() {
    			...
    			section.innerHTML = `<h1 id="intro-hed" class="svelte-2ztgw0">Correlation between Car Accidents and Time</h1> 
  <h1 class="intro-sub svelte-2ztgw0">How does time of the day manipulate car accident rates</h1> 
  <h3 id="introdate" class="svelte-2ztgw0"><a href="https://github.com/brybrycha" target="_blank">Chole Kim, Bryan Cha</a>, May 2024</h3>`;

    			attr(section, "id", "intro");
    			attr(section, "class", "svelte-2ztgw0");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$5(ctx) {
    	...
    	return {
    		c() {
    			...
    			section.innerHTML = `<p class="body-text"><span class="bold"></span> We were interested in researching about the how does time of the day affects car accidents rate, and we used car accidents data in Camdens, UK. 
    ...
    change the design of maps and bar chart data design, it is going to be challenging.</p> 
  <p class="body-text">This is a trr</p>`;
    ...
    */
    ...
    function create_fragment$4(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div0, "class", "info-box svelte-1soki1n");
    			attr(div1, "id", "map");
    			attr(div1, "class", "svelte-1soki1n");
    			attr(div2, "id", "map-container");
    			attr(div2, "class", "svelte-1soki1n");
    			attr(button0, "class", "svelte-1soki1n");
    			attr(button1, "class", "svelte-1soki1n");
    			attr(div3, "class", "button-container svelte-1soki1n");
    		},
    		m(target, anchor) {
    			insert(target, div2, anchor);
    			append$1(div2, div0);
    			append$1(div0, strong);
    			append$1(div0, t1);
    			append$1(div0, t2);
    			append$1(div2, t3);
    			append$1(div2, div1);
    			...
    			append$1(div3, button0);
    			append$1(div3, t6);
    			append$1(div3, button1);

    			if (!mounted) {
    				dispose = [
    					listen(button0, "click", /*toggleDaytime*/ ctx[1]),
    					listen(button1, "click", /*toggleNighttime*/ ctx[2])
    				];
    		...
    		p(ctx, [dirty]) {
    			if (dirty & /*totalAccidents*/ 1) set_data(t2, /*totalAccidents*/ ctx[0]);
    		},
    		i: noop,
    		o: noop,
    		d(detaching) {
    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		c() {
    			...
    			t1 = text$1(":00");
    			attr(div0, "class", "clock svelte-1ir8fsq");
    			attr(div1, "class", "clock-container svelte-1ir8fsq");
    		},
    		m(target, anchor) {
    		...
    		p(ctx, [dirty]) {
    			if (dirty & /*currentHour*/ 1) set_data(t0, /*currentHour*/ ctx[0]);
    		},
    		i: noop,
    		o: noop,
    		d(detaching) {
    ...
    class Clock extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { currentHour: 0, onChangeHour: 1 });
    	}
    }
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c() {
    			section = element("section");
    			div0 = element("div");
    			div0.innerHTML = `<h1>Accident with Time</h1>`;
    			t1 = space();
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	function drawLineGraph() {
    		...
    		function updateLineGraph(hour) {
    			...
    			y.domain([0, max(accidentCounts, d => d.count)]);
    ...
    class MapDayNight extends SvelteComponent {
    	constructor(options) {
    		super();
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			...
    			t4 = space();
    			div1 = element("div");
    			div1.innerHTML = `<svg id="dual-bar-chart"></svg>`;
    			attr(label, "for", "year-slider");
    			attr(input, "id", "year-slider");
    			attr(input, "type", "range");
    			attr(input, "min", "2015");
    			attr(input, "max", "2019");
    			input.value = /*selectedYear*/ ctx[0];
    			attr(span, "class", "year-label svelte-31tzsk");
    			attr(div0, "class", "slider-container svelte-31tzsk");
    			attr(div1, "class", "chart-container svelte-31tzsk");
    			attr(div2, "class", "container svelte-31tzsk");
    		},
    		m(target, anchor) {
    			insert(target, div2, anchor);
    			append$1(div2, div0);
    		...
    		p(ctx, [dirty]) {
    			...
    			if (dirty & /*selectedYear*/ 1) set_data(t3, /*selectedYear*/ ctx[0]);
    		},
    		i: noop,
    		o: noop,
    		d(detaching) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	function drawChart(data) {
    		...
    		const maxCount = max(data, d => Math.max(d.daytime, d.nighttime));
    ...
    function instance($$self) {
    	...
    	function updatePieChartData() {
    		...
    		filteredData.filter(d => d.Time !== null && d.Time >= 6 && d.Time < 18).length;
    		filteredData.filter(d => d.Time !== null && (d.Time < 6 || d.Time >= 18)).length;

    		filteredData.filter(d => d.driverSex === 'Male').length;
    		filteredData.filter(d => d.driverSex === 'Female').length;
    		filteredData.filter(d => d.driverSex === 'Not Traced').length;
    	}
